$(document).ready(function() {
	...
	if (typeof user_onboarded == 'undefined') {
		$("#section-intro").show();
		$("#section-intro").html("<div class='section-intro-container'><img src='https://gradoapp.com/website/assets/logo_green_large.png' id='section-intro-logo' width='45px' alt='say hello to grado'></div>");
